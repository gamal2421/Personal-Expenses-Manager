...
<div class="main-page">
    ...
    <div id="sidebar">
        ...
        <ul class="nav-menu">
            <li class="nav-item"><a href="dashboard.jsp"><i class="fas fa-chart-pie icons"></i> Dashboard</a></li>
            <li class="nav-item"><a href="Financials goals.jsp"><i class="fas fa-wallet icons"></i> Financials</a></li>
            <li class="nav-item"><a href="reports.jsp"><i class="fas fa-file-alt icons"></i> Reports</a></li>
            <li class="nav-item"><a href="budget.jsp" style="background-color: #3ab19b; color: white;"><i class="fas fa-money-bill-wave icons"></i> Budget</a></li>
            <li class="nav-item"><a href="income.jsp"><i class="fas fa-hand-holding-usd icons"></i> Income</a></li>
            <li class="nav-item"><a href="categories.jsp"><i class="fas fa-tags icons"></i> Categories</a></li>
        </ul>
    </div>
